...
int main (int argc, char *argv[]) {
    ...
    */
    ...
    snprintf(lat_name, 40, "./cont_proc_lat_%dt_%dgetchance.csv", n_threads-1, get_chance);
    snprintf(tp_name, 40, "./cont_proc_tp_%dt_%dgetchance.csv", n_threads-1, get_chance);
